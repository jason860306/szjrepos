...
public class MapCli {
	...
	Vector<LocNode> nodeVec = null;
	
	public Vector<LocNode> getNodeVec() {
		return nodeVec;
	}
...
//		}
	...
	public String SendRequest(String devID, double radius, MapLoc loc) {
		...
		try {
			...
			dostrm.close();
			sock.close();
			nodeVec = locResponse.getlocvec();
//			return locResponse.getlocvec();
			return locResponse.toString();
		} catch (Exception e) {
			e.printStackTrace();
		}
		return null;
