...
int main(int argc, char* argv[])
{
    ...
    // set encrypttion RSA instance (with only n and e),
    // to resemble the key distribution process
    ...
    int encrypt_size = RSA_public_encrypt(strlen((char*)input_string), input_string,
                                          encrypt_string, encrypt_rsa,
    ...
    // decrypt
    int decrypt_size = RSA_private_decrypt(encrypt_size, encrypt_string, decrypt_string,
